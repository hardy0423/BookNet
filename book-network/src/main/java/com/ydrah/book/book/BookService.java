...
import com.ydrah.book.common.PageResponse;
import com.ydrah.book.exception.OperationNotPermittedException;
import com.ydrah.book.file.FileStorageService;
import com.ydrah.book.history.BookTransactionHistory;
import com.ydrah.book.history.BookTransactionHistoryRepository;
import com.ydrah.book.user.User;
import static com.ydrah.book.book.BookSpecification.withOwnerId;
...
public class BookService {
    ...
    /**
     * This operation is only allowed for the owner of the book.
     * The method performs the following steps:
     * - Fetches the book from the database
     * - Retrieves the authenticated user
     * - Validates that the user is the owner of the book
     * - Toggles the shareable status
    ...
    /**
     * Updates the archived status of a book by toggling its current value.
     * This operation is restricted to the owner of the book.
     * The method performs the following actions:
     * - Retrieves the book by its ID
     * - Extracts the authenticated user from the security context
     * - Ensures that the authenticated user is the owner of the book
     * - Toggles the archived status (archived ↔ not archived)
     * - Saves the updated book
     *
